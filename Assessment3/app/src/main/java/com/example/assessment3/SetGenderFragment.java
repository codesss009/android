...
RadioGroup radioGroup;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.buttonSet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Integer selected_gender = radioGroup.getCheckedRadioButtonId();
                RadioButton gender = radioGroup.findViewById(selected_gender);
                selected_gen = gender.getText().toString();
                mListener.sendGender(selected_gen);
