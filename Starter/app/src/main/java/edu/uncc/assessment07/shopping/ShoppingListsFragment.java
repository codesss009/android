...
public class ShoppingListsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        FirebaseAuth mAuth = FirebaseAuth.getInstance();
        db.collection("Shopping Lists").whereEqualTo("ownerId", mAuth.getUid()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        class ShopListsViewHolder extends RecyclerView.ViewHolder{
            ...
            public void setupUI(ShoppingList shoppingList){
                ...
                mBinding.imageViewDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        FirebaseFirestore db =  FirebaseFirestore.getInstance();
                        db.collection("Shopping Lists").document(mShoppingList.docId).delete();
