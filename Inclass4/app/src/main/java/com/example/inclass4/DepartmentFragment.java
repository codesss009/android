...
public class DepartmentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RadioSelected = view.findViewById(R.id.radioGroup);
        buttonSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Integer selected = RadioSelected.getCheckedRadioButtonId();
                RadioButton select = RadioSelected.findViewById(selected);
                SelectedDepartment = select.getText().toString();
                mListener.sendDepartment(SelectedDepartment);
            }
        });
    ...
    public interface DepartmentFragmentListener{
        void sendDepartment(String Dept);
        void cancel();
    }
}